...
const TABLE = {
  ...
  infsubj: {
    ...
    pred: {
      ...
      exercise: "healthy", help: "important", travel: "exciting",
    },
    rows: {
      nom: {
  ...
  infcomp: {
    ...
    pred: {
      ...
      job: "to help people", step: "to ask", hope: "to travel",
    },
    rows: {
      nom: {
  ...
  infobj: {
    ...
    pred: {
      want: "to go shopping", need: "to get up early", hope: "to win the game",
      wish: "to travel abroad", decide: "to study harder", promise: "to call him",
      learn: "to swim", plan: "to visit Busan", like: "to read", love: "to take pictures",
    },
    rows: {
      obj: {
  ...
  infpurpose: {
    ...
    pred: {
      ...
      milk: "to buy some milk", bus: "to catch the first bus", stage: "to see the stage better",
    },
    rows: {
      purp: {
        find: [
  ...
  infadj: {
    ...
    pred: {
      ...
      homework: "to do", chair: "to sit on", pen: "to write with", time: "to waste",
    },
    rows: {
      adjr: {
  ...
  infindef: {
    ...
    pred: {
      cold: "something cold", sweet: "something sweet", interesting: "nothing interesting",
      kind: "someone kind", available: "anyone available", strong: "someone strong",
    },
    rows: {
      adjr: {
...
function build() {
  ...
  for (const [id, set] of Object.entries(TABLE)) {
    ...
    sets.push({
      ...
      qSubjects: set.qSubjects, // 형태와 무관하게 의문문인 주어 묶음 (anyone ~?)
      pred: set.pred,
